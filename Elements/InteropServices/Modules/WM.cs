...
namespace Elements.InteropServices
{
    ...
    public enum WM : uint
    {
        ...
        /// <summary>
        /// The user has selected the task list. A shell application that provides a task list
        /// should return TRUE to prevent Windows from starting its task list.
        /// </summary>
        HSHELL_TASKMAN = 7,
