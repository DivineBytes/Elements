...
namespace Elements.Models
{
    ...
    public static class DebuggerDisplay
    {
        ...
        /// <summary>
        /// Serializes the target to a more read able string for debugging.
        /// </summary>
        ...
        /// <summary>
        /// Returns a string that represents the current object for debug details.
        /// </summary>
        /// <param name="target">The target instance.</param>
        /// <param name="propertyName">The property name.</param>
        /// <returns>The <see cref="string"/>.</returns>
        ...
        /// <summary>
        /// Generate a single identification output with its value pair.
        /// </summary>
